...
word_t ext(word_t id, vm_t *vm) {
	...
	switch (id) {
		...
		case (14) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(strncpy((char *)(arg[0]), (const char *)(arg[1]), arg[2])))); break;
		case (15) : EXT_DEFINE_FUNC(2, STACK_PUSH((word_t)(strcat((char *)(arg[0]), (const char *)(arg[1]))))); break;
		case (16) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(strncat((char *)(arg[0]), (const char *)(arg[1]), arg[2])))); break;
		case (17) : EXT_DEFINE_FUNC(2, STACK_PUSH(strcmp((const char *)(arg[0]), (const char *)(arg[1])))); break;
		case (18) : EXT_DEFINE_FUNC(3, STACK_PUSH(strncmp((const char *)(arg[0]), (const char *)(arg[1]), arg[2]))); break;
		case (19) : EXT_DEFINE_FUNC(2, STACK_PUSH((word_t)(strchr((const char *)(arg[0]), arg[1])))); break;
		case (20) : EXT_DEFINE_FUNC(2, STACK_PUSH((word_t)(strstr((const char *)(arg[0]), (const char *)(arg[1]))))); break;
		case (21) : EXT_DEFINE_FUNC(1, STACK_PUSH((word_t)(strlen((const char *)(arg[0]))))); break;
		case (22) : EXT_DEFINE_FUNC(2, STACK_PUSH((word_t)(strtok((char *)(arg[0]), (const char *)(arg[1]))))); break;
		case (23) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(memcpy((void *)(arg[0]), (const void *)(arg[1]), arg[2])))); break;
		case (24) : EXT_DEFINE_FUNC(3, STACK_PUSH(memcmp((const void *)(arg[0]), (const void *)(arg[1]), arg[2]))); break;
		case (25) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(memchr((const void *)(arg[0]), arg[1], arg[2])))); break;
		case (26) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(memset((void *)(arg[0]), arg[1], arg[2])))); break;

		// = = = = stdlib.h = = = =
		case (27) : EXT_DEFINE_FUNC(1, STACK_PUSH(atoi((void *)(arg[0])))); break;
		case (28) : EXT_DEFINE_FUNC(3, STACK_PUSH((word_t)(itoa(arg[0], (char *)(arg[1]), arg[2])))); break;
